 ...
 *
 * Плюсами обектов есть простота в использовании, настройка области видимости, защина от неправильных запросов к данным, удобстро при
 * разширении классов, простота при создании новых обектов
 * Минусами есть то, что для поддержки кода нужно понимание работы, нужны дополкительные настройки, при малениких задачах может быть
 * сильно награмажден код
 *
 */
